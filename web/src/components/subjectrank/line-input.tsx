...
// One source for the limits. The design kept its own copy in the engine;
// two copies of a number the API also validates against is how a client
// starts accepting input the server will reject.
const { minLines: MIN_LINES, maxLines: MAX_LINES } = PRODUCT.limits;
