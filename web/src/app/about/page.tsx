/*
 * Ported from the handed-over design (exact-match-main/src/routes/about.tsx).
...
export const metadata = {
  ...
  description: "Why SubjectRank compares instead of scoring, what happens to the lines you paste, and how to delete everything in one action.",
};
